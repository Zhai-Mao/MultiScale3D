...
ann_file = '/root/autodl-tmp/pyskl-main/tools/data/ntu60_hrnet.pkl'
...
train_pipeline = [
    ...
    dict(type='GeneratePoseTarget', with_kp=True, with_limb=True, skeletons=skeletons),
...
# optimizer
optimizer = dict(type='SGD', lr=0.14, momentum=0.9, weight_decay=0.0003)  # this lr is used for 8 gpus
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_ntu60_xsub/joint_two_stream'
