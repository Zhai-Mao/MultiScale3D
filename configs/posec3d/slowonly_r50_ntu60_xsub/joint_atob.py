...
# optimizer
optimizer = dict(type='SGD', lr=0.13, momentum=0.9, weight_decay=0.0003)  # this lr is used for 8 gpus
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_ntu60_xsub/joint_ntu60_senet_finalfusion_atob'
