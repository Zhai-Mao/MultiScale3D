...
ann_file = '/root/autodl-tmp/pyskl-main/tools/data/hmdb51_hrnet.pkl'
...
# optimizer
optimizer = dict(type='SGD', lr=0.00375, momentum=0.9, weight_decay=0.0001)  # this lr is used for 8 gpus
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_hmdb51_k400p/s1_joint_lr0.00375'
